...
export class Convert {
  public static toBookModel(json: string): BookModel {
    return cast(JSON.parse(json), r("BookModel"));
  }

  public static bookModelToJson(value: BookModel): string {
    return JSON.stringify(uncast(value, r("BookModel")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  VolumeInfo: o(
    [
      ...
      { json: "publishedDate", js: "publishedDate", typ: u(undefined, Date) },
  ...
  Dimensions: o(
    [
      ...
      { json: "thickness", js: "thickness", typ: u(undefined, "") },
    ],
    false
  ),
  ImageLinks: o(
    [
      ...
      { json: "extraLarge", js: "extraLarge", typ: u(undefined, "") },
    ],
    false
  ),
